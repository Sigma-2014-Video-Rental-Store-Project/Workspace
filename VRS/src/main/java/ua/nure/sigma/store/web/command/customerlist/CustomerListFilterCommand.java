...
public class CustomerListFilterCommand extends Command {
    ...
    private static Map<String, IListFilterState<Customer>> filterStateMap;

    static {
        filterStateMap = new HashMap<String, IListFilterState<Customer>>();
    ...
    public String execute(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        if (filterParam != null && !filterParam.isEmpty()) {
            ...
            IListFilterState<Customer> state = filterStateMap.get(filterParam);
            if(state != null){
