...
<f:view>
    ...
    <form action="controller" method="post" name="filmDetails">
        ...
        <input type="hidden" name="returnTo" value="controller?command=filmDetails&filmId=${editFilmObject.filmId}"/>
        <input type="hidden" name="filmId" value="${editFilmObject.filmId}"/>

        <div id="content-body">
            <div id=leftside>
                <p id="text">${editFilmObject.title} (${editFilmObject.year}) <a
                        href="controller?command=editFilm&filmId=${editFilmObject.filmId}&get=true">edit</a></p>
            ...
            <div id=rightside>
                ...
                <div>
                    <textarea name="description" class="form-control" rows="6" style="margin-bottom:2%;"
                              readonly>${editFilmObject.description}</textarea>
                </div>
                <div>
                    ...
                    <div style="float:right; width:45%; max-width:45%;">
                        ...
                        <div style="float:right; width:30%;">
                            <input type="number" name="Days" class="form-control"
                                   style="margin-bottom:2%; margin-left:3%;" min="1" max="100" value="1">
                        </div>
                    </div>
                </div>
                <div style="margin-top:10%;">
                    <div style="float:right; clear:left; width:50%;">
                        <div style="float:right;">
                            <c:choose>
                                <c:when test="${uf:isAdded(editFilmObject.filmId,sessionScope.cart)}">
                                    <span style="font-weight: bold;">Already added to the cart.</span>
                                </c:when>
                                <c:otherwise>
