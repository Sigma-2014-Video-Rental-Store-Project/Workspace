...
<link rel="stylesheet" href="css/bootstrap-formhelpers.min.css"><%@ taglib
...
<link rel="icon" href="">
<title><fmt:message key="editcustomer.title" /></title>
</head>
<body>
	<div id="header">
	...
	<div id="content-body">
		<form action="controller" id="form" method="post"
			...
			<input type="hidden" id="customerCommand" name="command"
				value="editCustomerSave" /> <input type="hidden" name="customerId"
				value="${editCustomerObject.customerID}" />
			<div id="leftside">
				<div id="bordered" style="margin-bottom: 2%;">
					<img id="cover" data-src="holder.js/140x140" class="center"
						src="customerPhoto/${editCustomerObject.customerPhoto}">
				</div>
			...
			<div id="rightside">
				<div style="float: left; width: 100%;">
					<div style="float: left;">
						<p id="text">
							<fmt:message key="newcustomer.firstname" />
						</p>
					</div>
					<div style="float: right; width: 60%;">
						<input type="text" name="firstName" class="form-control"
							style="margin-bottom: 2%; margin-left: 1%;"
							value="${editCustomerObject.firstName}">
					</div>
				</div>
				<div style="float: left; width: 100%;">
					<div style="float: left;">
						<p id="text">
							<fmt:message key="newcustomer.lastname" />
						</p>
					</div>
					<div style="float: right; width: 60%;">
						<input type="text" name="lastName" class="form-control"
							style="margin-bottom: 2%; margin-left: 1%;"
							value="${editCustomerObject.lastName}">
					</div>
				</div>
				<div style="float: left; width: 100%;">
					<div style="float: left;">
						<p id="text">
							<fmt:message key="newcustomer.midname" />
						</p>
					</div>
					<div style="float: right; width: 60%;">
						<input type="text" name="middleName" class="form-control"
							style="margin-bottom: 2%; margin-left: 1%;"
							value="${editCustomerObject.middleName}">
					</div>
				</div>
				<div style="float: left; width: 100%;">
					<div style="float: left;">
					...
					<div style="float: right; width: 60%;">
						<input type="email" name="email" class="form-control"
							...
							value="${editCustomerObject.customerEmail}">
					</div>
				</div>
				<div style="float: left; clear: left; width: 100%;">
					<div style="float: left;">
						<p id="text">
							<fmt:message key="newcustomer.phone" />
						</p>
					</div>
					<div style="float: right; width: 60%;">
						<input name="phone" type="text" class="form-control bfh-phone"
							value="${editCustomerObject.customerPhone}"
				...
				<div style="float: left; clear: left; width: 100%;">
					<div style="float: left;">
						<p id="text">
							<fmt:message key="newcustomer.bonus" />
						</p>
					</div>
					<div style="float: right; width: 60%;">
				...
				<div style="float: left; clear: left; width: 100%;">
					<div style="float: left;">
						<p id="text">
							<fmt:message key="newcustomer.sex" />
						</p>
					</div>
					<div style="float: right; width: 60%;">
				...
				<div style="float: right; width: 100%;">
					...
					<div style="float: right; margin-left: 1%;">
						<button class="btn btn-danger"
							onclick="submitCustomerForm('delete')">
							<fmt:message key="editcustomer.remove" />
						</button>
					</div>
