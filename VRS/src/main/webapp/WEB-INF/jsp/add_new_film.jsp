						...
						<div style="float: left; width: 45%;">
							...
							<div style="float: right; width: 30%">
								<input type="number" name="amount" class="form-control"
									style="margin-bottom: 2%; margin-left: 3%;" min="0" max="150"
									value="0" />
							</div>
						</div>
						...
						<div style="float: right; width: 45%; max-width: 45%;">
							...
							<div style="float: right; width: 30%;">
								<input name="bonus" type="text" class="form-control"
									style="margin-bottom: 2%; margin-left: 3%;" value="" />
							</div>
						</div>
					</div>
					<div>
						...
						<div style="float: right; clear: left; width: 50%;">
							<div style="float: right;">
								<button type="submit" class="btn btn-success"
									style="margin-left: 3%;">
									<fmt:message key="filmlist.addNewFilmbtn" />
								</button>
							</div>
							<div style="float: right;">
