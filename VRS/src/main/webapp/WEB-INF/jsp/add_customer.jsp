...
<link rel="icon" href="">
<title><fmt:message key="newcustomer.title" /></title>
</head>
<body>
	<div id="header">
			...
			<div id=rightside>
				<div style="float: left; width: 100%;">
					<div style="float: left;">
						<p id="text"><fmt:message key="newcustomer.firstname" /></p>
					</div>
				...
				<div style="float: left; width: 100%;">
					<div style="float: left;">
						<p id="text"><fmt:message key="newcustomer.lastname" /></p>
					</div>
					<div style="float: right; width: 60%;">
				...
				<div style="float: left; width: 100%;">
					<div style="float: left;">
						<p id="text"><fmt:message key="newcustomer.midname" /></p>
					</div>
					<div style="float: right; width: 60%;">
				...
				<div style="float: left; clear: left; width: 100%;">
					<div style="float: left;">
						<p id="text"><fmt:message key="newcustomer.phone" /></p>
					</div>
					<div style="float: right; width: 60%;">
						<input name="phone" type="text" class="form-control bfh-phone"
							value="" data-format="+38 (ddd) ddd-dddd"
							style="margin-bottom: 2%; margin-left: 1%;">
					</div>
				</div>
				<div style="float: left; clear: left; width: 100%;">
					<div style="float: left;">
						<p id="text"><fmt:message key="newcustomer.bonus" /></p>
					</div>
					<div style="float: right; width: 60%;">
				...
				<div style="float: left; clear: left; width: 100%;">
					<div style="float: left;">
						<p id="text"><fmt:message key="newcustomer.sex" /></p>
					</div>
					<div style="float: right; width: 60%;">
				...
				<div style="float: right;">
					...
					<div style="float: right;">
						<a href="controller?command=customerList"><button
								type="button" class="btn btn-default"><fmt:message key="addfilm.cancel" /></button></a>
					</div>
				</div>
