...
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"1.jpg", 3, 200.0, 5.0, 1.0); /* Schindler`s List */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"2.jpg", 10, 300.0, 7.5, 0.5);  /* The Shawshank Redemption */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"3.jpg", 1, 500.0, 20.0, 2.0); /* The Green Mile */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"4.jpg", 6, 160.0, 4.0, 0.0); /* Forrest Gump */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"5.jpg", 12, 320.0, 10.0, 1.0); /* Intouchables */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"6.jpg", 14, 200.0, 2.0, 0.0);  /* A Beautiful Mind */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"7.jpg", 8, 100.0, 1.0, 0.0);  /* The Lion King */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
...
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"11.jpg", 2, 190.0, 2.0, 0.5); /* La Vita e bella */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"12.jpg", 1, 500.0, 10.0, 3.0); /* Ivan Vasilievich changing profession */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"13.jpg", 21, 240.0, 3.0, 0.0); /* Knockin on Heaven`s Door */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"14.jpg", 21, 240.0, 3.0, 0.0); /* The Godfather */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"15.jpg", 13, 140.0, 2.0, 0.0);  /* The Prestige */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"16.jpg", 10, 265.0, 2.7, 1.7); /* Lock, Stock and Two Smoking Barrels */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"17.jpg", 4, 280.0, 3, 0.0);  /* Pulp Fiction */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"18.jpg", 7, 380.0, 3.5, 0.5); /* Operation «Y» and other adventures Shurika */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	...
	"19.jpg", 10, 190.0, 2.0, 0.5); /* The Lord of the Rings: The Return of the King */
INSERT INTO FILMS (FILM_ID, TITLE, YEAR, DESCRIPTION, COVER, AMOUNT, GENERAL_PRICE, RENT_PRICE, BONUS_FOR_RENT)
	VALUES(20, "Гладиатор", 2000, "В великой Римской империи не было военачальника, равного генералу Максимусу. ",
	"20.jpg", 2, 450.0, 8.0, 1.5); /* Gladiator */

UPDATE FILMS SET TITLE='Список Шиндлера', DESCRIPTION= 'Лента рассказывает историю Оскара Шиндлера, члена нацистской партии, преуспевающего фабриканта, спасшего во время Второй мировой войны более тысячи ста евреев.'  WHERE FILM_ID=1;

UPDATE FILMS SET TITLE='Побег из Шоушенка', DESCRIPTION='Банкир Энди Дюфрейн обвинен в убийстве жены и ее любовника. Оказавшись в тюрьме Шоушенк, он сталкивается беззаконием, царящим по обе стороны решетки'  WHERE FILM_ID=2;


UPDATE FILMS SET TITLE='Зеленая миля', DESCRIPTION='Обвиненный в страшном преступлении, Джон Коффи оказывается в блоке смертников тюрьмы «Холодная гора».'  WHERE FILM_ID=3;

UPDATE FILMS SET TITLE='Форрест Гамп', DESCRIPTION= 'От лица главного героя Форреста Гампа, слабоумного безобидного человека с благородным и открытым сердцем, рассказывается история его необыкновенной жизни.'  WHERE FILM_ID=4;
